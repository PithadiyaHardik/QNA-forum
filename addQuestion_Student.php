...
<html lang="en">
  ...
  <div class="card">
        ...
        </svg>&nbsp <?php session_start(); echo $_SESSION['email']?></div>
        <div class="card-body">
        <h6 class="card-title"> Question</h6>
        <div class="card-text" id="question" contenteditable="true">Q.</div>
        </div>
        <button class="btn btn-success" style="width:150px" email= "<?php echo $_SESSION['email']?>"onclick="addQuestion(this)">SUBMIT</button>
    ...
    <script language="JavaScript" type="text/javascript" src="addQuestion.js"></script>
